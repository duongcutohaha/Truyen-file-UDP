...
### 2️⃣ Chạy Client
run as với client để chọn file và gửi file
## 📌 Ghi chú
- Vì gửi qua UDP nên không đảm bảo thứ tự & không đảm bảo không mất gói
- Nếu file to hoặc mạng kém → có thể mất gói, file bị lỗi.
